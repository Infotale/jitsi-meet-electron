...
class HelpButton extends Component<*, State> {
  ...
  constructor() {
    ...
    this._onPrivacyClick = openExternalLink.bind(undefined, config.privacyPolicyURL);
    this._onTermsClick = openExternalLink.bind(undefined, config.termsAndConditionsURL);
    this._onSendFeedbackClick = openExternalLink.bind(undefined, config.feedbackURL);
  }
    ...
    return (
      <Droplist
        ...
        <Group heading={t("help")}>
          <Item onActivate={this._onTermsClick}>{t("termsLink")}</Item>
          <Item onActivate={this._onPrivacyClick}>{t("privacyLink")}</Item>
          <Item onActivate={this._onSendFeedbackClick}>{t("sendFeedbackLink")}</Item>
          <Item onActivate={this._onAboutClick}>{t("aboutLink")}</Item>
          <Item onActivate={this._onSourceClick}>{t("sourceLink")}</Item>
          <Item>{t("versionLabel", { version })}</Item>
        </Group>
      </Droplist>
    );
  }
